import {
  ...
  VariableDeclaration,
  Accessor,
} from "three/addons/transpiler/AST.js"
...
class ShaderToyDecoder extends GLSLDecoder {
  constructor() {
    ...
    this.addPolyfill(
      "fragCoord",
      "vec3 fragCoord = vec3( viewportCoordinate.x, viewportResolution.y - viewportCoordinate.y, viewportCoordinate.z );"
    )
    this.addPolyfill("iUv", "vec2 iUv = uv();")
  }
